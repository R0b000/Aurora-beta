...
import { forgetPasswordValidation, type forgetPasswordProps } from "./auth.validation"
...
const ForgetPassword = () => {
    ...
    const { control, handleSubmit, formState: { errors } } = useForm<forgetPasswordProps>({
        defaultValues: {
            email: ''
        },
    ...
    return (
        <>
            <form onSubmit={handleSubmit(submitForm)}>
                <div className='flex flex-col h-[16vh] items-center justify-center w-full'>
