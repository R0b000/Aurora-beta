...
END
ELSE IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[categories]') AND name = 'public_id')
BEGIN
    ALTER TABLE [dbo].[categories] ADD public_id NVARCHAR(500) NULL;
END
GO