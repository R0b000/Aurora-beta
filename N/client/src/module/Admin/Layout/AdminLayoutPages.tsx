...
const AdminLayoutPage = () => {
    ...
    const navItems = [
        { path: '/admin', label: 'Dashboard', icon: AiOutlineHome },
        { path: '/admin/users', label: 'Users', icon: AiOutlineUser },
        { path: '/admin/category', label: 'Categories', icon: MdCategory },
        { path: '/admin/banner', label: 'Banners', icon: FaImage },
        { path: '/admin/coupon', label: 'Coupons', icon: RiCoupon3Line },
    ];
        ...
        <div className="flex min-h-screen bg-slate-50">
            ...
            >
                ...
                <div className="h-12 flex items-center px-3 border-b border-slate-200 gap-2">
                    <div 
                        className="flex items-center justify-center w-7 h-7 bg-blue-500 rounded-md cursor-pointer"
                        onClick={() => navigate('/')}
                    >
